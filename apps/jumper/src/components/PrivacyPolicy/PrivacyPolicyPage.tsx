...
export const PrivacyPolicyPage = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      content:
        'We process different categories of your personal data for different purposes. Below you can see which personal data we process in which contexts, for which purposes and on which legal basis we base the respective processing.',
    },
    {
      key: 'visitingWebsites',
      title: '3.1. Visiting our Websites',
      content:
        'When visiting our Websites for informational purposes, i.e., mere viewing and without you providing us with any other information, certain personal data is automatically collected each time the Websites is visited and stored in so-called server log files/databases. These are:',
      items: [
    ...
    },
    {
      ...
      content: `We review this privacy policy regularly and may update it at any time. If we make changes to this privacy policy, we will change the date of the last update above. Please review this privacy policy regularly to be aware of any updates. The current version of the privacy notice can be accessed at any time at ${JUMPER_URL}`,
    },
  ];

  ...
  return (
    ...
    >
      ...
      <Stack spacing={1}>
        ...
        >
          Source wallet and destination wallet are filled from this account automatically.
        </Typography>
      </Stack>
      ...
      <Stack spacing={1.5}>
        {walletFleet.isLoading ? (
          <Stack
            direction="row"
            spacing={1}
            sx={{ alignItems: 'center', color: (theme.vars || theme).palette.text.secondary }}
          >
            <CircularProgress size={16} />
            <Typography variant="bodySmall">Preparing chain wallets...</Typography>
          </Stack>
        ) : null}

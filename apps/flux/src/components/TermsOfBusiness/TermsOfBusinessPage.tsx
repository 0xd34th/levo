...
export const TermsOfBusinessPage = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      title: '10. Indemnity',
      content:
        "You agree to hold harmless, release, defend, and indemnify Ultima Liquiditas JE BVI Ltd., our affiliates and our and our affiliates' respective officers, directors, employees, contractors, agents, service providers, licensors, and representatives (collectively, the “xterm.fi Parties”) from and against all claims, damages, obligations, losses, liabilities, costs, and expenses (including reasonable attorney's fees) arising from or relating to: (a) your access and use of any of our Functionality or any Third-Party Functionality; (b) your violation of any clause of these Terms, the right of any third party, or any other applicable law, rule, or regulation; (c) any other party's access and use of any of our Functionality or any Third-Party Functionality with your assistance or using any device or account that you own or control; and (d) any dispute between you and (i) any other user of any of the Functionality or any Third-Party Functionality or (ii) any of your own customers or users. We reserve the right to assume the exclusive defense and control of any matter which is subject to indemnification under this section, and you agree to cooperate with any reasonable requests assisting our defense of such matter. You may not settle or compromise any claim against any xterm.fi Party without our written consent. ",
    },
    {
